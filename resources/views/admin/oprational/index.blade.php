<x-app-layout>
    ...
    <div class="flex flex-wrap gap-4 justify-center p-6">
        <!-- Card for RGB -->
        <a href="{{route('oprational.rgb')}}" class="block bg-gray-800 shadow-md rounded-lg p-4 w-full sm:w-64 flex flex-col items-center text-center hover:shadow-lg transition duration-300 ease-in-out transform hover:scale-105">
            <!-- Icon -->
        ...
        <!-- Card for RBM -->
        <a href="{{route('oprational.rbm')}}" class="block bg-gray-800 shadow-md rounded-lg p-4 w-full sm:w-64 flex flex-col items-center text-center hover:shadow-lg transition duration-300 ease-in-out transform hover:scale-105">
            <!-- Icon -->
