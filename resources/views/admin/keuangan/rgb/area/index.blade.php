                ...
                <tbody>
                    ...
                    @foreach ($data as $account)
                        <tr>
                            ...
                            <td class="p-3 text-center uppercase">{{ $account->created_at ?? $account->updated_at }}
                            </td>
                            <td class="p-3 text-center">
                                <a href="{{ route('Area.edit', $account->id) }}"
                                    class="text-blue-500 hover:underline">Edit</a>
                                <form action="{{ route('Area.destroy', $account->id) }}" method="POST"
            ...
            <div class="p-4">
                <form action="{{ route('Area.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="tunj_makan" id="tunj_makan"
                            class="w-full px-3 py-2 border rounded-md text-black" required>
                    </div>
                    <div class="mb-4">
                        <label for="tunj_trans" class="block text-white">Tunjangan Transport</label>
                        <input type="number" name="tunj_trans" id="tunj_trans"
                            class="w-full px-3 py-2 border rounded-md text-black" required>
                    </div>
                    <div class="mb-4">
                        <label for="inventaris" class="block text-white">Inventaris</label>
                        <input type="text" name="inventaris" id="inventaris"
                            class="w-full px-3 py-2 border rounded-md text-black" required>
                    </div>
                    <div class="mb-4">
