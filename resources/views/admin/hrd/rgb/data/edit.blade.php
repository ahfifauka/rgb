        ...
        <div class="mt-8">
            ...
            <form method="POST"
                ...
                <div class="mb-4">
                    ...
                    <select id="marital_status" name="marital_status"
                        ...
                        <option value="" disabled
                            {{ old('marital_status', $account->marital_status ?? '') == '' ? 'selected' : '' }}>Pilih
                            Status Pernikahan</option>
                        <option value="Belum Menikah"
                            {{ old('marital_status', $account->marital_status ?? '') == 'Belum Menikah' ? 'selected' : '' }}>
                            Belum Menikah</option>
                        <option value="Menikah"
                            {{ old('marital_status', $account->marital_status ?? '') == 'Menikah' ? 'selected' : '' }}>
                            Menikah</option>
                        <option value="Janda/Duda"
                            {{ old('marital_status', $account->marital_status ?? '') == 'Janda/Duda' ? 'selected' : '' }}>
                            Janda/Duda</option>
                    </select>
                </div>
                ...
                <div class="">
                    ...
                    <div id="sim-options" class="ml-6 flex gap-2">
                        <div class="flex items-center mb-2">
                ...
                <div class="">
                    ...
                    <div id="ijazah-options" class="ml-6 flex gap-2">
                        <div id="ijazah-options" class=" flex gap-2">
                            <div class="flex items-center mb-2">
                                <input type="radio" id="smp" name="ijazah_level" value="smp"
                                    class="mr-2"
                                    {{ old('ijazah_level', $account->ijazah_level ?? '') == 'smp' ? 'checked' : '' }}>
                                <label for="smp" class="text-gray-300">SMP</label>
                            </div>
                            <div class="flex items-center mb-2">
                                <input type="radio" id="sma" name="ijazah_level" value="sma"
                                    class="mr-2"
                                    {{ old('ijazah_level', $account->ijazah_level ?? '') == 'sma' ? 'checked' : '' }}>
                                <label for="sma" class="text-gray-300">SMA</label>
                            </div>
                            <div class="flex items-center mb-2">
                                <input type="radio" id="sarjana" name="ijazah_level" value="sarjana"
                                    class="mr-2"
                ...
                <div class="mb-4">
                    <div class="flex items-center mb-2">
                        <input type="checkbox" id="kta" name="kta" value="1"
                    ...
                    <div class="flex flex-wrap md:flex-nowrap gap-2">
                        @foreach (['Islam', 'Kristen', 'Katolik', 'Hindu', 'Budha', 'Konghucu'] as $agama)
                            <div class="flex items-center mb-2 md:mb-0">
                                <input type="radio" id="agama{{ $loop->index }}" name="agama"
                                    value="{{ $agama }}"
                                    {{ old('agama', $account->agama ?? '') == $agama ? 'checked' : '' }}>
                                <label for="agama{{ $loop->index }}"
                                    class="text-gray-300">{{ $agama }}</label>
                            </div>
                        @endforeach
                    </div>
                </div>
