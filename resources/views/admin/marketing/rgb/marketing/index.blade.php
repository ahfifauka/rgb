            ...
            <table id="data-table" class="min-w-full bg-gray-800 text-white rounded-md">
                <thead>
                    <tr>
                        ...
                        <th class="p-3 text-center">Project Name</th>
                        <th class="p-3 text-center">Contac Person</th>
                        <th class="p-3 text-center">Number Phone</th>
                        <th class="p-3 text-center">Position</th>
                        <th class="p-3 text-center">Address</th>
                        <th class="p-3 text-center">Prediction Time</th>
                        <th class="p-3 text-center">Proggres</th>
                        <th class="p-3 text-center">Personil Requirement</th>
                ...
                <tbody>
                    ...
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td class="p-3 text-center uppercase">{{ $item->project }}</td>
                            <td class="p-3 text-center uppercase">{{ $item->contac_person }}</td>
                            <td class="p-3 text-center uppercase">{{ $item->nohp }}</td>
                            <td class="p-3 text-center uppercase">{{ $item->posisi }}</td>
                            <td class="p-3 text-center uppercase">{{ $item->alamat }}</td>
                            <td class="p-3 text-center uppercase">{{ $item->prediksi }}</td>
                            <td class="p-3 text-center uppercase">{{ $item->proggres }}</td>
                            <td class="p-3 text-center uppercase">{{ $item->personil_r }}</td>
                            <td class="p-3 text-center uppercase">{{ $item->hasil }}</td>
                            <td class="p-3 text-center">
                                <a href="{{ route('MarketingPlan.edit', $item->id) }}"
                                    class="text-blue-500 hover:underline">Edit</a>
                                <form action="{{ route('MarketingPlan.destroy', $item->id) }}" method="POST"
