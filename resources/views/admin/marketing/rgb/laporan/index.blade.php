            ...
            <table id="data-table" class="min-w-full bg-gray-800 text-white rounded-md">
                <thead>
                    <tr>
                        ...
                        <th class="p-3 text-center">Nama Perusahaan</th>
                        <th class="p-3 text-center">Alamat</th>
                        <th class="p-3 text-center">Contac Person</th>
                        <th class="p-3 text-center">No Telp / Hp</th>
                        <th class="p-3 text-center">Kebutuhan</th>
                ...
                <tbody>
                    ...
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td class="p-3 text-center uppercase">{{ $item->perusahaan }}</td>
                            <td class="p-3 text-center uppercase">{{ $item->alamat }}</td>
                            <td class="p-3 text-center uppercase">{{ $item->contac }}</td>
                            <td class="p-3 text-center uppercase">{{ $item->nohp }}</td>
                            <td class="p-3 text-center uppercase">{{ $item->kebutuhan }}</td>
                            <td class="p-3 text-center uppercase">{{ $item->progres }}</td>
